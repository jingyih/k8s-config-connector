...
type EmailPreferences struct {
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.EmailPreferences.enable_failure_email
...
type ScheduleOptions struct {
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.ScheduleOptions.disable_auto_scheduling
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.ScheduleOptions.start_time
	...
	//  moment. The time when a data transfer can be triggered manually is not
	//  limited by this option.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.ScheduleOptions.end_time
...
type ScheduleOptionsV2 struct {
	...
	//  option.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.ScheduleOptionsV2.time_based_schedule
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.ScheduleOptionsV2.manual_schedule
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.ScheduleOptionsV2.event_driven_schedule
...
type TimeBasedSchedule struct {
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TimeBasedSchedule.schedule
	...
	//  defined in the schedule string. The start time can be changed at any
	//  moment.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TimeBasedSchedule.start_time
	StartTime *string `json:"startTime,omitempty"`

	// Defines time to stop scheduling transfer runs. A transfer run cannot be
	//  scheduled at or after the end time. The end time can be changed at any
	//  moment.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TimeBasedSchedule.end_time
	EndTime *string `json:"endTime,omitempty"`
}
...
type UserInfo struct {
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.UserInfo.email
...
type Any struct {
	...
	// +kcc:proto=google.protobuf.Any.type_url
	TypeURL *string `json:"typeURL,omitempty"`

	// Must be a valid serialized protocol buffer of the above specified type.
	// +kcc:proto=google.protobuf.Any.value
