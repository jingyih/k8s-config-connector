...
type Status struct {
	...
	// +kcc:proto=google.rpc.Status.code
	...
	//  by the client.
	// +kcc:proto=google.rpc.Status.message
...
type BigQueryDataTransferConfigSpec struct {
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.data_refresh_window_days
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.data_source_id
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.disabled
	Disabled *bool `json:"disabled,omitempty"`

	// User specified display name for the data transfer.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// Email notifications will be sent according to these preferences
	//  to the email address of the user who owns this transfer config.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.email_preferences
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.encryption_configuration
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.params
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.schedule
	Schedule *string `json:"schedule,omitempty"`

	// Options customizing the data transfer schedule.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.schedule_options
...
type BigQueryDataTransferConfigObservedState struct {
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.dataset_region
	...
	//  config.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.name
	Name *string `json:"name,omitempty"`

	// Output only. Next time when data transfer will run.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.next_run_time
	...
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.owner_info
	OwnerInfo *UserInfo `json:"ownerInfo,omitempty"`

	// Output only. State of the most recently updated transfer run.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.state
	State *string `json:"state,omitempty"`

	// Output only. Data transfer modification time. Ignored by server on input.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.update_time
	UpdateTime *string `json:"updateTime,omitempty"`

	// Deprecated. Unique ID of the user on whose behalf transfer is done.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.user_id
	UserID *int64 `json:"userID,omitempty"`

	// Output only. Error code with detailed information about reason of the
	//  latest config failure.
	// +kcc:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig.error
