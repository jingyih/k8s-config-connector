...
export PROTO_PACKAGE=google.cloud.aiplatform.v1
export PROTO_SERVICE=google.cloud.aiplatform.v1.Featurestore
export CRD_GROUP=${SERVICE}.cnrm.cloud.google.com

export PROTO_MESSAGE=google.cloud.aiplatform.v1.Featurestore
