...
// mappers: BigQueryDataTransferConfigSpec_FromProto, BigQueryDataTransferConfigSpec_ToProto, BigQueryDataTransferConfigObservedState_FromProto, BigQueryDataTransferConfigObservedState_ToProto
EOF
```
